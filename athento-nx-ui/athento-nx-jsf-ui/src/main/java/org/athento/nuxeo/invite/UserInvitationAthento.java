 ...
 * Contributors:
 */
package org.athento.nuxeo.invite;
 ...
 * @contibutor athento
 */
@Path("/userInvitationAthento")
@Produces("text/html;charset=UTF-8")
@WebObject(type = "userRegistrationAthento")
public class UserInvitationAthento extends ModuleRoot {
    private static final Log log = LogFactory.getLog(UserInvitationAthento.class);
    ...
    public Object validateTrialForm() throws Exception {
        ...
        try {
            ...
            additionalInfo.put(UserInvitationAthento.PASSWORD_KEY, password);
