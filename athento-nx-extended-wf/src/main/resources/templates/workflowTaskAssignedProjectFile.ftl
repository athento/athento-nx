                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        El proyecto <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docUrl}">${docTitle}</a> necesita aprobación y <strong>ha sido asignado a usted</strong> o a un grupo al que pertenece.
                        </p><br/>
                        <p style="margin:0;font-size:14px;">
